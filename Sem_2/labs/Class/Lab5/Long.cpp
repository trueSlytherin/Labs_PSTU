...
void Long::Show() {
    cout << "LONG" << endl;
    cout << "starshaya chast = " << first << endl;
    cout << "mladshaya chast = " << second << endl;
}

istream& operator>>(istream& in, Long& l) {
    cout << "starshaya chast = ";
    in >> l.first;
    cout << "mladshaya chast = ";
    in >> l.second;
    return in;
}

ostream& operator<<(ostream& out, const Long& l) {
    out << "starshaya chast = " << l.first << endl;
    out << "mladshaya chast = " << l.second << endl;
    return out;
}
